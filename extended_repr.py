...
def specRateCL():
    ...
    rates[2] = plac_expr_rate - (scb2_degr_rate + growthRate)*scb2;
    ...
    rates[5] = ptetr_expr_rate - (c14_degr_rate + growthRate)*c14;
    ...
    rates[8] = pci_expr_rate - (c4_degr_rate + growthRate)*c4;
