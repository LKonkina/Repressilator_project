...
def specRateCL(): # Add if/else, new species
    ...
    return cl_prefix + '''
        ...
        rates[8] = plac_expr_rate - (scbb_degr_rate + growthRate)*scbb;
        rates[1] = scbb * scb2_k2 - (scb2_degr_rate + growthRate)*scb2 + Dscb2*(scb2-scb2_in)*area/gridVolume;
        ...
        rates[9] = plac_expr_rate - (cini_degr_rate + growthRate)*cini;
        rates[2] = cini * c14_k2 - (c14_degr_rate + growthRate)*c14 + Dc14*(c14-c14_in)*area/gridVolume;
        rates[0] = Dc4*(c4-c4_in)*area/gridVolume - c4_degr_rate*c4;
        ...
        float plac_r = (laci/k_plac)**n_plac;
        float plac_expr_rate = (a0_plac+a1_plac*plac_r)/(1+plac_r);
        rates[7] = plac_expr_rate - (rhli_degr_rate + growthRate)*rhli;
        rates[0] = rhli * c4_k2 - (c4_degr_rate + growthRate)*c4 + Dc4*(c4-c4_in)*area/gridVolume;
